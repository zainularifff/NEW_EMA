...
.software-policy-module{height:100%;min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr);gap:12px;color:#0f2746;overflow:hidden}.software-policy-module *{box-sizing:border-box}.sp-card,.sp-hero{border:1px solid #dbe7fb;border-radius:20px;background:#fff;box-shadow:0 14px 30px rgba(15,23,42,.045)}.sp-hero{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:14px;align-items:center;padding:16px 18px}.sp-hero h2,.sp-head h3{margin:4px 0;color:#0f2746;font-weight:900;letter-spacing:-.05em}.sp-hero p,.sp-head p{margin:0;color:#64748b;font-size:.72rem;font-weight:700}.sp-steps{display:flex;gap:8px;align-items:center}.sp-step-pill{white-space:nowrap;padding:9px 12px;border-radius:999px;border:1px solid #dbe7fb;background:#f8fbff;color:#31517a;font-size:.68rem;font-weight:900}.sp-body{min-height:0;display:grid;grid-template-columns:300px minmax(0,1fr);gap:12px;overflow:hidden}.sp-left,.sp-main{min-height:0;display:grid;gap:12px;overflow:hidden}.sp-left{grid-template-rows:auto minmax(0,1fr)}.sp-main{grid-template-rows:auto minmax(0,1fr) minmax(0,.72fr)}.sp-card{min-height:0;overflow:hidden;display:flex;flex-direction:column}.sp-head,.sp-card-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:14px 16px;border-bottom:1px solid #e5edf8}.sp-card-head strong{display:block;margin-top:4px;font-weight:900}.sp-field{display:grid;gap:6px;padding:0 16px 12px}.sp-field.compact{padding:0}.sp-field span{color:#64748b;font-size:.62rem;font-weight:900;text-transform:uppercase}.sp-field input,.sp-field select,.sp-field textarea,.sp-search input,.sp-row select{width:100%;min-height:38px;border:1px solid #d7e3f5;border-radius:12px;background:#fff;color:#0f2746;padding:0 12px;font-size:.76rem;font-weight:750}.sp-field textarea{min-height:64px;padding:10px}.sp-primary,.sp-icon,.sp-danger,.sp-toggle button{min-height:38px;border-radius:12px;font-size:.74rem;font-weight:900}.sp-primary{margin:0 16px 16px;border:0;color:#fff;background:linear-gradient(135deg,#2563eb,#087ea4)}.sp-toolbar .sp-primary,.sp-simple-rule .sp-primary{margin:0;padding:0 14px}.sp-icon,.sp-danger{width:38px;border:1px solid #d7e3f5;background:#fff;color:#2563eb}.sp-danger{border-color:#fecaca;color:#dc2626;background:#fff1f2}.sp-list{flex:1;display:grid;align-content:start;gap:8px;padding:12px;overflow:auto}.sp-list-item{width:100%;display:grid;gap:3px;padding:12px;text-align:left;border:1px solid #dbe7fb;border-radius:14px;background:#f8fbff;color:#0f2746}.sp-list-item.active{color:#fff;background:linear-gradient(135deg,#2563eb,#087ea4)}.sp-list-item span,.sp-list-item small{color:#64748b;font-size:.68rem;font-weight:750}.sp-list-item.active span,.sp-list-item.active small{color:rgba(255,255,255,.82)}.sp-alert{padding:9px 14px;border-radius:14px;font-size:.74rem;font-weight:850}.sp-alert.error{color:#991b1b;background:#fef2f2;border:1px solid #fecaca}.sp-alert.success{color:#166534;background:#f0fdf4;border:1px solid #bbf7d0}.sp-alert.info{color:#1d4ed8;background:#eff6ff;border:1px solid #bfdbfe}.sp-toolbar{display:grid;grid-template-columns:220px minmax(0,1fr) auto;align-items:end;gap:10px;padding:12px 16px;border-bottom:1px solid #e5edf8}.sp-search{min-height:38px;display:flex;align-items:center;gap:8px;border:1px solid #d7e3f5;border-radius:12px;padding:0 11px;background:#fff;color:#64748b}.sp-search input{min-height:0;border:0;padding:0}.sp-table{flex:1;min-height:0;overflow:auto}.sp-row{min-width:780px;display:grid;gap:10px;align-items:center;border-bottom:1px solid #edf2f7;color:#0f2746;font-size:.72rem;font-weight:740}.sp-source .sp-row{grid-template-columns:42px minmax(230px,1.2fr) minmax(150px,.75fr) minmax(120px,.55fr) minmax(160px,.7fr);min-height:52px;padding:0 14px}.sp-items .sp-row{grid-template-columns:minmax(250px,1.25fr) 112px 118px minmax(200px,1fr) 46px;min-height:58px;padding:0 14px}.sp-row.head{position:sticky;top:0;z-index:2;min-height:44px;background:#f3f7fc;color:#64748b;font-size:.62rem;font-weight:900;text-transform:uppercase}.sp-row.selected{background:#eff6ff}.sp-row strong,.sp-row small{display:block;overflow:hidden;text-overflow:ellipsis}.sp-row small{color:#64748b;font-size:.62rem}.sp-empty{min-height:100px;display:grid;place-items:center;color:#64748b;font-size:.76rem;font-weight:800}.sp-simple-rule{padding:13px 16px}.sp-rule-summary{display:grid;grid-template-columns:1fr auto;gap:12px;align-items:start;margin-bottom:12px}.sp-rule-summary strong{display:block;font-weight:900}.sp-rule-summary small{display:block;color:#64748b;font-size:.68rem;font-weight:750}.sp-rule-basic{display:grid;grid-template-columns:1fr 1fr 1fr 1fr auto;gap:10px;align-items:end}.sp-toggle{display:flex;gap:8px}.sp-toggle button{border:1px solid #d7e3f5;background:#fff;color:#64748b;padding:0 12px}.sp-toggle .legal{color:#166534;border-color:#bbf7d0;background:#f0fdf4}.sp-toggle .restricted{color:#991b1b;border-color:#fecaca;background:#fef2f2}.sp-advanced{margin-top:10px;border:1px solid #e5edf8;border-radius:14px;background:#f8fbff}.sp-advanced summary{cursor:pointer;padding:10px 12px;color:#31517a;font-size:.72rem;font-weight:900}.sp-advanced-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;padding:0 12px 12px}.sp-usage-line{display:block;color:#64748b;font-size:.62rem;font-weight:750;line-height:1.35}@media(max-width:1280px){.management-control-wrapper.settings-management-shell,.sp-hero,.sp-body{grid-template-columns:1fr!important}.sp-steps{overflow-x:auto}.sp-rule-basic{grid-template-columns:1fr 1fr}.sp-advanced-grid{grid-template-columns:repeat(2,1fr)}}
`;
...
function SoftwarePolicyManagement() {
  ...
  const summary = useMemo(() => {
    ...
    const restricted = policyItems.filter((item) => ["restricted", "unapproved"].includes(String(item.ComplianceStatus).toLowerCase())).length;
    ...
    <section className="software-policy-module">
      <header className="sp-hero">
        <div>
          ...
          <p>Simple flow: create rule, choose category, tick software, then save status and license setting.</p>
        </div>
        <div className="sp-steps">
          <span className="sp-step-pill">1. Create rule</span>
          <span className="sp-step-pill">2. Select software</span>
          <span className="sp-step-pill">3. Save setting</span>
        </div>
      </header>
      ...
      <div className="sp-body">
        <aside className="sp-left">
          <div className="sp-card">
            <div className="sp-card-head"><div><span className="sp-chip">Step 1</span><strong>Create rule</strong></div><FilePlus2 size={18} /></div>
            ...
            <button className="sp-primary" type="button" onClick={createPolicy} disabled={saving || loading}><Save size={15} /> Create Rule</button>
          </div>

          <div className="sp-card">
            <div className="sp-card-head"><div><span className="sp-chip">Saved rules</span><strong>{policies.length} record(s)</strong></div><button className="sp-icon" type="button" onClick={loadBase} disabled={loading}><RefreshCw size={15} /></button></div>
            <div className="sp-list">
              {policies.length === 0 ? <div className="sp-empty">No rule yet.</div> : policies.map((policy) => (
                <button key={policy.PolicyID} type="button" className={`sp-list-item ${policy.PolicyID === activePolicyId ? "active" : ""}`} onClick={() => setActivePolicyId(policy.PolicyID)}>
                  <strong>{policy.PolicyName}</strong>
                  <span>{policy.CategoryName || "No category"}</span>
                  <small>{policy.TotalItems || 0} software • {policy.LegalCount || 0} legal • {policy.IllegalCount || policy.RestrictedCount || 0} restricted</small>
                </button>
              ))}
            </div>
          </div>
        ...
        <main className="sp-main">
          <section className="sp-card">
            <div className="sp-head">
              <div><span className="sp-chip">Step 2</span><h3>{activePolicy ? activePolicy.PolicyName : "Select or create a rule"}</h3><p>Select category, search software, then tick the software to include.</p></div>
              {message && <div className={`sp-alert ${message.type}`}>{message.text}</div>}
            </div>
            <div className="sp-toolbar">
              <label className="sp-field compact"><span>Category</span><select value={categoryId} onChange={(event) => updateActivePolicyCategory(event.target.value)} disabled={!activePolicy}><option value="">Select category</option>{categories.map((category) => <option key={category.CategoryID} value={category.CategoryID}>{category.CategoryName}</option>)}</select></label>
              ...
              <button className="sp-primary" type="button" onClick={saveSelectedSoftware} disabled={!activePolicy || selectedRows.length === 0 || saving}><CheckCircle2 size={15} /> Save Selected ({selectedRows.length})</button>
            </div>
            <div className="sp-table sp-source">
              <div className="sp-row head"><span></span><span>Software</span><span>Publisher</span><span>Version</span><span>Computer / Department</span></div>
              {softwareLoading ? <div className="sp-empty">Loading software inventory...</div> : softwareRows.length === 0 ? <div className="sp-empty">Select category to display mapped software list.</div> : softwareRows.map((row) => {
                const key = getSoftwareKey(row);
                return <label key={key} className={`sp-row ${selectedKeys.has(key) ? "selected" : ""}`}><span><input type="checkbox" checked={selectedKeys.has(key)} onChange={() => toggleSoftware(row)} /></span><span><strong>{row.SoftwareName}</strong><small>{row.CategoryName}</small></span><span>{row.Publisher || "-"}</span><span>{row.Version || "-"}</span><span><strong>{row.ComputerName || "-"}</strong><small>{row.Department || row.Username || "-"}</small></span></label>;
              })}
            </div>
          </section>

          <section className="sp-card sp-simple-rule">
            <div className="sp-rule-summary">
              <div><span className="sp-chip">Step 3</span><strong>Setting for selected software</strong><small>Only fill the important fields first. Advanced usage thresholds are optional.</small></div>
              <small>{selectedRows.length} selected</small>
            </div>
            <div className="sp-rule-basic">
              <label className="sp-field compact"><span>Status</span><div className="sp-toggle"><button type="button" className={ruleDraft.complianceStatus === STATUS_LEGAL ? "legal" : ""} onClick={() => updateRule({ complianceStatus: STATUS_LEGAL })}><ShieldCheck size={14} /> Legal</button><button type="button" className={ruleDraft.complianceStatus === STATUS_RESTRICTED ? "restricted" : ""} onClick={() => updateRule({ complianceStatus: STATUS_RESTRICTED })}><ShieldAlert size={14} /> Restricted</button></div></label>
              ...
              <label className="sp-field compact"><span>No. license</span><input type="number" min="0" step="1" value={ruleDraft.licenseCount} onChange={(event) => updateRule({ licenseCount: event.target.value })} /></label>
              <label className="sp-field compact"><span>License ref</span><input value={ruleDraft.licenseRef} onChange={(event) => updateRule({ licenseRef: event.target.value })} /></label>
              <button className="sp-primary" type="button" onClick={saveSelectedSoftware} disabled={!activePolicy || selectedRows.length === 0 || saving}>Apply</button>
            </div>
            <details className="sp-advanced">
              <summary>Advanced usage and license period</summary>
              <div className="sp-advanced-grid">
                <label className="sp-field compact"><span>Work start</span><input type="time" value={ruleDraft.workingStartTime} onChange={(event) => updateRule({ workingStartTime: event.target.value })} /></label>
                <label className="sp-field compact"><span>Work end</span><input type="time" value={ruleDraft.workingEndTime} onChange={(event) => updateRule({ workingEndTime: event.target.value })} /></label>
                <label className="sp-field compact"><span>Utilized h/day</span><input type="number" min="0" step="0.5" value={ruleDraft.utilizedHours} onChange={(event) => updateRule({ utilizedHours: event.target.value })} /></label>
                <label className="sp-field compact"><span>Under h/day</span><input type="number" min="0" step="0.5" value={ruleDraft.underUtilizedHours} onChange={(event) => updateRule({ underUtilizedHours: event.target.value })} /></label>
                <label className="sp-field compact"><span>Open count/day</span><input type="number" min="0" step="1" value={ruleDraft.openCountThreshold} onChange={(event) => updateRule({ openCountThreshold: event.target.value })} /></label>
                <label className="sp-field compact"><span>Not used h/day</span><input type="number" min="0" step="0.5" value={ruleDraft.notUsedHours} onChange={(event) => updateRule({ notUsedHours: event.target.value })} /></label>
                <label className="sp-field compact"><span>Start date</span><input type="date" value={ruleDraft.licenseStartDate} onChange={(event) => updateRule({ licenseStartDate: event.target.value })} /></label>
                <label className="sp-field compact"><span>End date</span><input type="date" value={ruleDraft.licenseEndDate} onChange={(event) => updateRule({ licenseEndDate: event.target.value })} /></label>
              </div>
            </details>
          </section>

          <section className="sp-card">
            <div className="sp-head"><div><span className="sp-chip">Saved software</span><h3>{summary.total} software item(s)</h3><p>Quick review of saved status, purchase and usage rule.</p></div></div>
            <div className="sp-table sp-items">
              <div className="sp-row head"><span>Software</span><span>Status</span><span>Purchase</span><span>Usage rule</span><span>Action</span></div>
              {policyItems.length === 0 ? <div className="sp-empty">No software has been added to this rule.</div> : policyItems.map((item) => (
                <div key={item.PolicyItemID} className="sp-row"><span><strong>{item.SoftwareName}</strong><small>{item.Publisher || "-"} • {item.Version || "-"}</small></span><span><select value={item.ComplianceStatus || STATUS_LEGAL} onChange={(event) => updateItem(item, { ComplianceStatus: event.target.value })}><option value={STATUS_LEGAL}>Legal</option><option value={STATUS_RESTRICTED}>Restricted</option></select></span><span><select value={item.PurchaseStatus || "Unknown"} onChange={(event) => updateItem(item, { PurchaseStatus: event.target.value })}><option value="Unknown">Unknown</option><option value="Purchased">Purchased</option><option value="Not Purchased">Not Purchased</option></select></span><span className="sp-usage-line">{item.WorkingStartTime || "09:00"}-{item.WorkingEndTime || "18:00"}<br />Utilized ≥ {item.UtilizedHours ?? 4}h • Opens ≥ {item.OpenCountThreshold ?? 1}</span><span><button className="sp-danger" type="button" onClick={() => deleteItem(item)}><Trash2 size={14} /></button></span></div>
              ))}
            </div>
          </section>
        </main>
